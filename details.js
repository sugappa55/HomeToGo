...
var hotel_data=JSON.parse(localStorage.getItem("hotel_data"))


var details={
  images:hotel_data.image,
  size:hotel_data.feature,
price:hotel_data.price,
location:hotel_data.location,
title:hotel_data.name1
}
var details_arr=details.size.split(".")
var main_image=document.getElementById("main_image");
main_image.src=hotel_data.imgUrl;
